...
public class SuperDuper {
    public static void main(String[] args) {
        Cat myCat = new Cat("Billota", 2, "fish");
        myCat.makeNoise(); //sublass overridden method
        myCat.eat(); //sub class method
            System.out.println(myCat.name + " " + myCat.age + " " + myCat.catFoodPreference);
    }
}
